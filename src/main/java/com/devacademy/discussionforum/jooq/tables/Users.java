...
import com.devacademy.discussionforum.jooq.tables.Messages.MessagesPath;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> PASSWORD_HASH = createField(DSL.name("password_hash"), SQLDataType.VARCHAR(60).nullable(false), this, "");

    /**
     * The column <code>public.users.is_admin</code>.
     */
    public final TableField<UsersRecord, Boolean> IS_ADMIN = createField(DSL.name("is_admin"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
